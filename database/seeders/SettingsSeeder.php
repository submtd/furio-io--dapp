...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        $settings = [
            ...
            'presale_one_start' => Carbon::parse('4/28/2022 13:00:00 MST')->timestamp,
            'presale_one_max' => 1,
            'presale_one_price' => 250,
            'presale_one_value' => 500,
            'presale_one_total' => 300,
            'show_presale_one_timer' => true,
            'presale_two_start' => Carbon::parse('5/3/2022 13:00:00 MST')->timestamp,
            'presale_two_max' => 10,
            'presale_two_price' => 150,
            'presale_two_value' => 100,
            'presale_two_total' => 1250,
            'show_presale_two_timer' => false,
            'presale_three_start' => Carbon::parse('5/6/2022 13:00:00 MST')->timestamp,
            'presale_three_max' => 10,
            'presale_three_price' => 175,
            'presale_three_value' => 100,
            'presale_three_total' => 1250,
            'show_presale_three_timer' => false,
            'claim_start' => Carbon::parse('6/1/2022 13:00:00 MST')->timestamp,
            'show_claim_timer' => false,
