...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        $settings = [
            ...
            'presale_one_start' => Carbon::now()->addMinutes(30)->timestamp,
            'presale_one_max' => 1,
