<template>
    <div class="modal fade" id="loginmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered loginmodal-center">
            <div class="modal-content loginmodal-size">
                ...
                <div class="modal-body d-flex flex-row justify-content-around">
                    <button @click="wallet.metamask" class="btn btn-wallet-connect" data-dismiss="modal">
                        ...
                        <button class="btn btn-wallet-connect" @click="wallet.walletconnect" data-dismiss="modal">
                            <svg width="45" height="45">
                                <path
